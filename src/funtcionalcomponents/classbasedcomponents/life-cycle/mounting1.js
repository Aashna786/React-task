...
class Mounting1 extends Component {
  ...
  componentDidMount() {
    const id = [
      ...new Set(this.state.products.map((product) => product.id)),
    ];
    this.setState({ id });
      ...
      <>
        <div id="nav">
          ...
          <div className="mb-4">
            <h2>Categories:</h2>
            <div>
              <button onClick={() => this.handleIdChange("")} id="button">
                All
              </button>
              {id.map((id, index) => (
                <button
                  key={index}
                  onClick={() => this.handleIdChange(id)}
                  id="button"
                >
                  {id}
                </button>
              ...
              <div key={eachProduct.id} className="col-md-4 mb-4">
                <Card id="card">
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>
                      Rating: {eachProduct.rating.rate} (
